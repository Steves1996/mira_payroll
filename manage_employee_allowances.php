	...
	<form action="" id="employee-allowance">
		...
		<div class="row form-group">
			...
			<div class="col-md-3">
				...
				<select id="month" class="borwser-default custom-select">
					<option value=""></option>
					<?php
					$allowance = $conn->query("SELECT * FROM mois");
					while ($row = $allowance->fetch_assoc()):
					?>
			...
			<div class="col-md-3"  id="dfield">
				...
				<select id="year" class="borwser-default custom-select">
					<option value=""></option>
					<?php
					$allowance = $conn->query("SELECT * FROM year");
					while ($row = $allowance->fetch_assoc()):
					?>
