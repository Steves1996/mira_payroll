...
<nav id="sidebar" class='mx-lt-5 bg-dark'>
	...
	<div class="sidebar-list">
		...
		<?php if ($_SESSION['login_department_id'] == 0): ?>
			...
			<a href="index.php?page=payroll" class="nav-item nav-payroll"><span class='icon-field'><i class="fa fa-columns"></i></span> Paies</a>
			<a href="index.php?page=semi_payroll" class="nav-item nav-semi_payroll"><span class='icon-field'><i class="fa fa-columns"></i></span> demi-Paies</a>
			<a href="index.php?page=employee" class="nav-item nav-employee"><span class='icon-field'><i class="fa fa-user-tie"></i></span> Employés</a>
		...
		<?php if ($_SESSION['login_type'] == 1): ?>
			...
			<a href="index.php?page=impot_cotisation" class="nav-item nav-impot_cotisation"><span class='icon-field'><i class="fa fa-bill"></i></span> Impot & Cotisation</a>
			<a href="index.php?page=year_month" class="nav-item nav-year_month"><span class='icon-field'><i class="fa fa-calender"></i></span> Periode</a>
